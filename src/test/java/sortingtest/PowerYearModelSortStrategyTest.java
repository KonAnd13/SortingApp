...
public class PowerYearModelSortStrategyTest {

    private static final String SORT_BY_POWER_TEST_NAME =
            "Проверка сортировки по мощности автомобиля.";
    ...
    public void sortByPowerTest() {
        List<Car> cars = new ArrayList<>(Arrays.asList(
            ...
            new Car("Ford Focus", 180, 2019),
            new Car("BMW X5", 130, 2022)
        ));
    ...
    public void sortByYearTest() {
        List<Car> cars = new ArrayList<>(Arrays.asList(
            ...
            new Car("Honda Accord", 150, 2020),
            new Car("Nissan Altima", 150, 2021)
        ));
    ...
    public void alreadySortedTest() {
        List<Car> cars = new ArrayList<>(Arrays.asList(
            ...
            new Car("Chevrolet Camaro", 120, 2020),
            new Car("Dodge Charger", 150, 2021)
        ));
    ...
    public void sizePreservationTest() {
        List<Car> cars = new ArrayList<>(Arrays.asList(
            ...
            new Car("Dodge Charger", 120, 2021)
        ));
